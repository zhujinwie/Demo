...
public class App extends Application {
    ...
    //客户测试 3
    public static final String RTSP_03_URL="rtsp://admin:admin@192.168.0.11:554/cam/realmonitor?channel=1&subtype=0";
    //小摄像头0
    ...
    /*    SharedPreferencesUtils.put(this, "MQ_QUEUE", "faceScreenQueue");
       ...
       if ("".equals(SharedPreferencesUtils.get(this, "MQ_HOST", ""))) {
        ...
        if ("".equals(SharedPreferencesUtils.get(this, "PLAY_PATH", ""))) {
         //   SharedPreferencesUtils.put(this, "PLAY_PATH", RTSP_03_URL);
